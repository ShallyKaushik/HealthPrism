...
function StressPage() {
  ...
  useEffect(() => {
    document.title = 'Stress Coach';
    window.scrollTo(0, 0); // FIX — page always starts at the top
  }, []);
  ...
  return (
    <div className="stress-page-container">
      ...
      <div className="stress-header">
        ...
        <p>
          Managing stress is not just about mental well-being—
          it's a critical part of cardiovascular health.
        </p>
      </div>
      ...
      <div className="stress-content">
        ...
        {/* --- 4. Stress-Heart Connection Section --- */}
        <div className="stress-card">
          ...
          <p>The good news is that simple, daily practices can make a huge difference.</p>
        </div>
          ...
          <div className="technique-grid">
            ...
            <div className="technique-card">
              <div
                ...
                style={{ backgroundColor: '#f3e8ff', color: 'var(--color-accent)' }}
              >
                <FaBrain />
              </div>
              <h3>Mindful Breathing</h3>
              <p>
                Take 5 minutes. Inhale slowly for 4 seconds, hold for 4,
                and exhale slowly for 6. This can calm your nervous system instantly.
              </p>
            </div>
            ...
            <div className="technique-card">
              <div
                className="technique-icon"
                style={{ backgroundColor: '#e0f3ff', color: 'var(--color-primary)' }}
              >
                <FaBed />
              </div>
              <h3>Prioritize Sleep</h3>
              <p>
                Aim for 7–9 hours of quality sleep. A lack of sleep raises cortisol levels.
            ...
            <div className="technique-card">
              <div
                className="technique-icon"
                style={{ backgroundColor: '#e0fff0', color: 'var(--color-secondary)' }}
              >
                <FaRunning />
              </div>
              ...
              <p>
                ...
                Even a 20-minute walk can clear your mind and lower blood pressure.
              </p>
            </div>
